...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Kshitcoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"Kshitcointools.com", "dnsseed.Kshitcointools.com"},
    {"Kshitcoinpool.org", "dnsseed.Kshitcoinpool.org"},
...
static const char *strTestNetDNSSeed[][2] = {
    {"Kshitcointools.com", "testnet-seed.Kshitcointools.com"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Kshitcoin is probably already running."), addrBind.ToString().c_str());
        else
